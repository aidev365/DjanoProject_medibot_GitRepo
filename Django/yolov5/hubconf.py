...
def yolov5ss(pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    # YOLOv5-small model https://github.com/ultralytics/yolov5
    return _create('yolov5ss', pretrained, channels, classes, autoshape, verbose, device)


def yolov5food(pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    # YOLOv5-small model https://github.com/ultralytics/yolov5
    return _create('yolov5food', pretrained, channels, classes, autoshape, verbose, device)
